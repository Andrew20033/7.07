...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static void Program3()
        {
            ...
            Console.WriteLine($"Numbers {ch1}{ch2}{ch3}{ch4}");
        ...
        static void Program4()
        {
            ...
            Console.WriteLine("Enter the first digit of the six-digit number ");
            a1 = Convert.ToInt16(Console.ReadLine());
            Console.WriteLine("Enter the second digit of the six-digit number ");
            a2 = Convert.ToInt16(Console.ReadLine());
            Console.WriteLine("Enter the third digit of the six-digit number ");
            a3 = Convert.ToInt16(Console.ReadLine());
            Console.WriteLine("Enter the fourth digit of the six-digit number ");
            a4 = Convert.ToInt16(Console.ReadLine());
            Console.WriteLine("Enter the fifth digit of the six-digit number ");
            a5 = Convert.ToInt16(Console.ReadLine());
            Console.WriteLine("Enter the six digit of the six-digit number ");
            a6 = Convert.ToInt16(Console.ReadLine());
            Console.WriteLine($"Yours number {a1}{a2}{a3}{a4}{a5}{a6}");

            Console.WriteLine("Enter the number of a pair of numbers that you would like to exchange for cities");
        }
        ...
        static void Program5()
        {
            int a, b;
            string p = "", p1 = "";
            a = EnterInt32("Enter the day of the month -");
            b = EnterInt32("Enter the month number -");
        ...
        static void Program7()
        {
            ...
            Console.Write($"Even numbers in the range between {a1} та {a2} =");
            if (a1 < a2)
            {
                int size = a2 - a1;
